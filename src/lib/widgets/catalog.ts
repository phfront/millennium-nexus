...
export const DASHBOARD_WIDGET_CATALOG: DashboardWidgetCatalogItem[] = [
  ...
  },
  {
    ...
    title: 'Daily Goals Resumo',
    description: 'Progresso do dia com pontuacao e streak.',
    moduleSlug: 'daily-goals',
    defaultVisible: true,
    defaultPosition: 3,
    minW: 1,
    minH: 1,
  ...
  },
  {
    ...
    title: 'Daily Goals Carrossel',
    description: 'Objetivos do dia com marcacao rapida.',
    moduleSlug: 'daily-goals',
    defaultVisible: true,
    defaultPosition: 4,
    minW: 1,
