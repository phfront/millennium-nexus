...
const NAV_LINKS = [
  { href: '/habits-goals', icon: <LayoutDashboard size={18} />, label: 'Hoje' },
  { href: '/habits-goals/history', icon: <History size={18} />, label: 'Histórico' },
  { href: '/habits-goals/config', icon: <Target size={18} />, label: 'Metas' },
  { href: '/habits-goals/notifications', icon: <Bell size={18} />, label: 'Notificações' },
];
...
export function ModuleSidebar() {
  return (
    <ModuleSidebarShell drawerId="habits-goals-module-sidebar">
